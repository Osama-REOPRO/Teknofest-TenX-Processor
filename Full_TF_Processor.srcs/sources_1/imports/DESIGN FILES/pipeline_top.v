...
//                     	.exp_st_acc_fault_o(exp_st_acc_fault) //TODO
    ...
    hazard_unit hazard_block (
                        .rst_i(rst), 
                        .pc_src_e_i(pc_src_e),
                        .register_write_m_i(register_write_m), 
                        .register_write_w_i(register_write_w), 
                        .rd_m_i(RD_M), 
                        .rd_w_i(rd_w), 
                        .rs1_e_i(forwarded_RS1_E), 
                        .rs2_e_i(forwarded_RS2_E), 
                        .forward_ae_o(ForwardAE), 
                        .forward_be_o(ForwardBE),
                        .flush_f_o(flush_F), 
                        .flush_d_o(flush_D), 
                        .flush_e_o(flush_E), 
                        .flush_m_o(flush_M),
